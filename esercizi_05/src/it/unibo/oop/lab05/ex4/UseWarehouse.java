...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
        final Product p1 = new ComparableProduct("PC", 300);
        final Product p2 = new ComparableProduct("Calcolatrice", 120);
        final Product p3 = new ComparableProduct("Scrivania", 5);
